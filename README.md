...
- **Buenas prácticas** — Código limpio, principios SOLID, refactorización y estándares de desarrollo.
- **Principios de diseño** — Fundamentos que guían la construcción de software mantenible, escalable y comprensible.
...
Este repositorio es de uso académico. Su contenido está orientado exclusivamente al aprendizaje en el marco de la asignatura.
